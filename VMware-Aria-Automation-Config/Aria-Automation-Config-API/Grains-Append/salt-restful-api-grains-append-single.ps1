...
Write-Host "Adding Grains to: $minionName..."
...
# ----- [ Start Add Grain Data ] -----
#Write-Host 'Adding Grain Data to minion...'
$grainKey = 'API-Grains'
$grainValue = '1'
...
$outPut = "Minion: " + $fullResults.id + ' | Success:' + $fullResults.success + ' | Command: ' + $fullResults.fun
Write-Host $outPut
